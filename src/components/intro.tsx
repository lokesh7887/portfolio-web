...
function Intro() {
  ...
  return (
    <section ref={ref} id="home"  className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
        <div className='flex item-center justify-center'>
            <div className='relative'>
              ...
              <motion.div
               ...
               >
              <Image src="https://pbs.twimg.com/profile_images/1636059751191830540/2BXfhuH3_400x400.jpg"
                 alt="Rokdeshwar photo" width="192" height="192"
                 quality="95"
                 priority={true}
      ...
      >
        <span className="font-bold">Hello, I'm Rokdeshwar. </span>
          I'm a{" "} <span className="font-bold">full-stack developer </span>
          with{" "} I enjoy building <span className="italic">sites & apps</span>. 
          My focus is{" "} <span className="underline">React (Next.js)</span>.
      </motion.h1>

      <motion.div className='flex flex-col sm:flex-row item-center justify-center gap-2
        ...
        py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110
          hover:scale-110 hover:bg-gray-950 active:scale-185
          transition'
          onClick={() => {
         ...
         <a className='group bg-dark px-7
        py-3 flex items-center gap-2 rounded-full outline-none
         focus:scale-110 hover:scale-110 active:scale-185
          transition cursor-pointer border border-black/10'
           href="/cv1.pdf" download > Dowonload CV <HiDownload
          className='opacity-60 group-hover:translate-y-1 transition '/> </a>
        ...
        items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-185
          transition cursor-pointer border border-black/10'
          href="https://github.com/lokesh7887" target="_blank"><FaGithubSquare/> </a>
      </motion.div>
